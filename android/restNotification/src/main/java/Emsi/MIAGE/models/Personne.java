	...
	@Id @GeneratedValue(strategy=GenerationType.IDENTITY)
	 private Long id;
		...
		public String toString() {
			return "Personne [username=" + username + ", password=" + password + ", email=" + email + ", fullname="
					+ fullname + ", age=" + age + ", filiere=" + filiere + ", niveau=" + niveau + ", groupe=" + groupe
					+ ", departement=" + departement + ", typePersonne=" + typePersonne + "]";
		}
